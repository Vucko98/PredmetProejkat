...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__quadstore_comunica_require__("../node_modules/relative-to-absolute-iri/lib/Resolve.js"), exports);
//# sourceMappingURL=index.js.map
...
class Sum extends BaseAggregator_1.BaseAggregator {
    ...
    put(state, term) {
        const internalTerm = this.termToNumericOrError(term);
        return this.summer.apply([state, internalTerm], this.sharedContext);
    }
    result(state) {
        return state.toRDF();
    }
...
class NonLexicalLiteral extends Literal {
    constructor(typedValue, typeURL, openWorldType, strValue, language) {
        super({ toString: () => 'undefined' }, Consts_1.TypeAlias.SPARQL_NON_LEXICAL, strValue, language);
...
class OverloadTree {
    ...
    search(args, superTypeProvider, functionArgumentsCache) {
        ...
        let searchIndex = 0;
        while (searchIndex < args.length && (cacheIter === null || cacheIter === void 0 ? void 0 : cacheIter.cache)) {
        ...
        if (searchIndex === args.length && (cacheIter === null || cacheIter === void 0 ? void 0 : cacheIter.func)) {
    ...
    _addOverload(argumentTypes, func, promotionCount) {
        ...
        if (argumentType === Consts_1.TypeURL.XSD_STRING) {
            this.addPromotedOverload(Consts_1.TypeURL.XSD_ANY_URI, func, arg => (0, Helpers_1.string)(arg.str()), _argumentTypes, promotionCount);
        }
        // TODO: in case of decimal a round needs to happen.
        if (argumentType === Consts_1.TypeURL.XSD_DOUBLE) {
            this.addPromotedOverload(Consts_1.TypeURL.XSD_FLOAT, func, arg => (0, Helpers_1.double)(arg.typedValue), _argumentTypes, promotionCount);
            this.addPromotedOverload(Consts_1.TypeURL.XSD_DECIMAL, func, arg => (0, Helpers_1.double)(arg.typedValue), _argumentTypes, promotionCount);
        }
        if (argumentType === Consts_1.TypeURL.XSD_FLOAT) {
            this.addPromotedOverload(Consts_1.TypeURL.XSD_DECIMAL, func, arg => (0, Helpers_1.float)(arg.typedValue), _argumentTypes, promotionCount);
        }
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isSubTypeOf = exports.getSuperTypeDict = exports.isInternalSubType = exports.asGeneralType = exports.asOverrideType = exports.asKnownLiteralType = exports.asTypeAlias = exports.typeAliasCheck = exports.extensionTableInit = exports.getSuperTypes = exports.superTypeDictTable = exports.extensionTableInput = void 0;
const expressions_1 = __quadstore_comunica_require__("../node_modules/sparqlee/dist/lib/expressions/index.js");
const Consts_1 = __quadstore_comunica_require__("../node_modules/sparqlee/dist/lib/util/Consts.js");
/**
...
const df_383_2 = new ((__quadstore_comunica_require__("../node_modules/@comunica/logger-void/lib/index.js").LoggerVoid))();
...
/******/ 	module.exports = __quadstore_comunica_exports__;
/******/ 	
/******/ })()
;